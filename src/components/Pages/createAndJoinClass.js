...
export function CreateAndJoin() {
    ...
    const createClassroom = (className) => {
        ...
        if (className.length > 0) {
            ...
            axios.post('http://localhost:5000/classrooms', classroomData).then((recievedResponse) => {
    ...
    const joinClassroom = (classCode) => {
        ...
        axios.post('http://localhost:5000/classrooms/searchcode', { "code": classCode }).then((recievedResponse) => {
